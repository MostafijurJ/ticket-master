...
import com.learn.ms.kafka.config.data.KafkaProducerConfigData;
import com.learn.ms.kafka.interceptor.KafkaProducerInterceptor;
...
public class KafkaProducerConfig {
    ...
    @Value(value = "${ms.kafka.bootstrap-servers}")
