package com.learn.ms.search_service.common.logger;


import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.learn.ms.search_service.common.annotations.CardNumberSerializer;
import com.learn.ms.search_service.common.annotations.SensitiveData;
import com.learn.ms.search_service.common.utils.JacksonUtil;
...
public abstract class BaseLoggerAspect {
    ...
    @Pointcut("@within(com.learn.ms.search_service.common.annotations.NoLogging)")
    public void noLogging() {
    }

    private final ObjectMapper objectMapper = JacksonUtil.objectMapper();
