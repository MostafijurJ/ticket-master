package com.learn.ms.event_service.common.aspect;

import com.learn.ms.event_service.common.logger.CommonTraceLoggerAspect;
...
public class ServiceTracingAspect extends CommonTraceLoggerAspect {
    ...
    @Pointcut("execution(* com.learn.ms.event_service.common.aspect.ServiceTracingAspect.logService(..))")
