package com.learn.ms.event_service.common.handlers;


import com.learn.ms.event_service.common.logger.ServiceLogger;
import com.learn.ms.event_service.common.utils.ResponseUtils;
import com.learn.ms.event_service.core.domain.enums.ApiResponseCode;
import com.learn.ms.event_service.core.domain.enums.ResponseMessage;
import com.learn.ms.event_service.core.domain.exceptions.CustomRootException;
import com.learn.ms.event_service.core.domain.exceptions.DatabaseException;
import com.learn.ms.event_service.core.domain.exceptions.DomainException;
import com.learn.ms.event_service.core.domain.exceptions.FeignClientException;
import com.learn.ms.event_service.core.domain.exceptions.InterServiceCommunicationException;
import com.learn.ms.event_service.core.domain.exceptions.InvalidRequestDataException;
import com.learn.ms.event_service.core.domain.exceptions.MethodNotAllowedException;
import com.learn.ms.event_service.core.domain.exceptions.OperationFailedException;
import com.learn.ms.event_service.core.domain.exceptions.OperationHoldException;
import com.learn.ms.event_service.core.domain.exceptions.RecordNotFoundException;
import com.learn.ms.event_service.core.domain.exceptions.UnauthorizedResourceException;
