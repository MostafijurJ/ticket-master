...
public class CardPaymentService extends BaseService implements PaymentService {
    private final TransactionHistoryRepository transactionHistoryRepository;
    private final TransactionHistoryMapper mapper;

    @Override
    public PaymentResponse processPayment(PaymentRequest request) {
        logger.trace("Processing payment for card: {}", request);

        // TODO external card payment related logic will be implemented here
